           ...
           <div class="relative  p-5 ">
              ...
              <ul class="flex space-x-6 mr-6 text-lg">
                ...
                <li>
                  ...
                  <button  x-on:click.prevent="$dispatch('open-modal', 'register');open = ! open;" href="{{route('register')}}" title="create new account" class="hover:bg-green-400 bg-black hover:text-black text-white py-2 px-5 rounded-full flex items-center gap-2"><svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24">
                ...
                <li>
                  <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'login')" href="/login" title="sign in" class="hover:bg-green-400 bg-black hover:text-black text-white py-2 px-5 rounded-full flex items-center gap-2">
            ...
            <div class="flex gap-20 w-screen  ">
              ...
              @php $id=auth()->user()->id // href="{{route('notify',$id)}}   (auth()->user()->notified==false) "
               @endphp
                ...
                <div x-data="{ showAccept: true }"> <button  x-show="showAccept"  @click="showAccept = false" title="accept email notifications" id="notify" class="hover:bg-green-400 hover:text-white flex items-center gap-2">Accept Notification <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <g fill="none">
...
@guest
<div >
<x-modal x-data=" 'openR' : false  " x-transition
x-init=" 'openR' = false "
name="login"
...
<x-guest-layout >
        ...
        <form method="POST" action="{{ route('login') }}" >
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-primary-button x-on:click="'openR' = false" class="ms-3">
                    {{ __('Log in') }}
                </x-primary-button>
            </div>
        </form>
...
<x-modal   x-data="" name="register" :show="$errors->get('Remail')||$errors->get('Rname')||$errors->get('Rpassword')"  >
