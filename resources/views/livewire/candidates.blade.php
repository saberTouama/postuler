                ...
                @foreach ($workers as $worker)
                    ...
                    <tr class="border-b hover:bg-blue-200">
                        ...
                        <td class="py-3 px-4">
                            ...
                            x-on:click.prevent="  $dispatch('open-modal', 'confirm-condidat-deletion'); document.getElementById('worker_id').value={{ $worker_id}} ;"  class="text-red-500 hover:underline" >
                                {{ __('Delete ❌') }}
                            </x-danger-button>
                        </td>
                    </tr>
    ...
    <x-modal name="confirm-condidat-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="/delete-condidate" class="p-6">
          ...
          @method('post')
            ...
            <div class="mt-6">
         <input    id="worker_id"    name="worker_id" type="number" value=1/>
            </div>
