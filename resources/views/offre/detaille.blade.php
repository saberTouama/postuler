...
<x-app-layout>
  ...
  @php session(['offre_id' => $offre->id]); @endphp
      <div class="mx-4 sm:justify-center bg-violet-100 dark:bg-gray-700 items-center pt-6 px-10 w-full text-gray-800 dark:text-gray-300  border   rounded-lg shadow-lg" tyle="border-radius: 10px;">
       @auth <button   x-data=""
...
<div class="flex relative left-10 top-1/3">
          ...
          @if($tool && $tool->path)
              <img  class="w-14 mr-3 mb-3 rounded-full" src="{{ asset('storage/' . $tool->path) }}" alt="Tool image" class="w-full h-auto" title="{{$tool->name}}">
          @else
   ...
   <div>
       ...
       <div  class=" justify-center flex " > <small class="ml-2 text-sm  flex gap-2 items-center "> <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 2048 2048">
...
<div>
  <div class="flex  items-center gap-2  justify-center">  <h1 class="text-3xl flex  mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            </svg>important:</h1></div>
            <div>{!! nl2br(e($offre->points)) !!}</div></div>
            <div>
            <div class="flex  items-center gap-2  justify-center">     <h3 class="text-3xl flex mb-4">  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
              ...
              <div>  <h3 class="text-3xl flex mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
            ...
            <div class="text-lg space-y-6">
                ...
                <div class="flex  w-1/4 rounded-lg justify-end  px-0">
                 @livewire('chirps')
