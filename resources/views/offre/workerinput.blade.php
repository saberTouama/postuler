        ...
        <x-app-layout>
            ...
            <div><h1>Postulez !!!</h1></div>
    <x-guest-layout>
        
    <form id="form" method="POST"  action="{{ route('worker.store') }}" enctype="multipart/form-data" >
        @csrf
        <div class="mt-4">
        ...
        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" /> </div><br><br>
       ...
       <div class="lg:grid lg:grid-cols-2 flex items-center gap-2"> <x-text-input type="file" id="cv" class="mt-4 rounded-full bg-white" name="cv" placeholder="your  cv" accept=".pdf,.doc,.docx" required />  <svg class="w-7 h-7 rounded-full" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
